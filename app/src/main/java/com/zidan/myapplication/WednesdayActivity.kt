...
class WednesdayActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addroutinebutton = findViewById<AppCompatButton>(R.id.add_wednesday)
        addroutinebutton.setOnClickListener {
            val intent = Intent(this, RoutineActivity::class.java)
            intent.putExtra("day", Calendar.WEDNESDAY)
    ...
    override fun onStart() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val alarms = db.alarmDAO().getWednesdayAlarm()
